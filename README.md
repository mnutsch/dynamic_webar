...
This is a proof of concept showing how to dynamically combine and divide different webAR pages. **Disclaimer: This code is experimental and may crash or not display properly on mobile devices. For best results user a PC with a webcam.**
